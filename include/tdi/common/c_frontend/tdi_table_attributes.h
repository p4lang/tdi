 ...
 */
typedef enum tdi_table_attributes_type_ {
...
typedef enum attributes_idle_table_mode {
  ...
  TDI_NOTIFY_MODE,
  TDI_INVALID_MODE
} tdi_attributes_idle_table_mode_t;
 ...
 */
tdi_status_t tdi_attributes_entry_scope_symmetric_mode_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_entry_scope_symmetric_mode_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_idle_table_poll_mode_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_idle_table_notify_mode_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_idle_table_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_port_status_notify_set(
    tdi_table_attributes_hdl *tbl_attr,
    const bool enable,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_port_status_notify_get(
    const tdi_table_attributes_hdl *tbl_attr,
    bool *enable,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_port_stats_poll_intv_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_port_stats_poll_intv_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_global_rid_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_global_rid_get(
    tdi_table_attributes_hdl *tbl_attr, uint32_t *global_rid);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_port_protection_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_port_protection_get(
    tdi_table_attributes_hdl *tbl_attr, bool *enable);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_fast_failover_set(
    tdi_table_attributes_hdl *tbl_attr, bool enable);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_fast_failover_get(
    tdi_table_attributes_hdl *tbl_attr, bool *enable);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_max_nodes_before_yield_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_max_nodes_before_yield_get(
    tdi_table_attributes_hdl *tbl_attr, uint32_t *count);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_max_nodes_threshold_set(
    tdi_table_attributes_hdl *tbl_attr,
    uint32_t node_count,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_pre_max_nodes_threshold_get(
    tdi_table_attributes_hdl *tbl_attr,
    uint32_t *node_count,
    uint32_t *node_port_lag_count);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_key_mask_num_fields_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_key_mask_fields_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_key_mask_set(
    tdi_table_attributes_hdl *tbl_attr,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_key_mask_num_bytes_get(
    tdi_table_attributes_hdl *tbl_attr,
    tdi_id_t field_id,
    uint32_t *num_bytes);
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_key_mask_bytes_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_hashing_set(
    tdi_table_attributes_hdl *tbl_attr,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_dyn_hashing_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_meter_byte_count_adjust_set(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_meter_byte_count_adjust_get(
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_selector_table_update_cb_set(
    tdi_table_attributes_hdl *tbl_attr,
    const bool enable,
 ...
 * @return Status of the API call
 */
tdi_status_t tdi_attributes_selector_table_update_cb_get(
    const tdi_table_attributes_hdl *tbl_attr,
    bool *enable,
