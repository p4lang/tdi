...
tdi_status_t tdi_table_info_get(const tdi_table_hdl *table_hdl,
  ...
  *table_info_hdl=reinterpret_cast<const tdi_table_info_hdl *>(table->tableInfoGet());
  return TDI_SUCCESS;
}
...
tdi_status_t tdi_table_id_from_handle_get(const tdi_table_info_hdl *table_info_hdl,
  ...
  auto tableInfo =
      reinterpret_cast<const tdi::TableInfo *>(table_info_hdl);
  *id = tableInfo->idGet();
  return TDI_SUCCESS;
}
...
tdi_status_t tdi_table_num_api_supported(const tdi_table_info_hdl *table_info_hdl,
                                         uint32_t *num_apis) {
